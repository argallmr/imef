...
from download_data_izzak import download_data_2d
from data_manipulation import average_data_2d


def collect_2d_data():
    # Start and End dates for download. Can be made into arguments if you want
    start_date = dt.datetime(2015, 9, 10, 3, 57, 19)
    end_date = dt.datetime(2015, 9, 11, 3, 50, 28)
    ...
    while start_date < end_date:
        ...
        try:
            ...
            new_data = download_data_2d("mms1", t0, t1)
        except Exception as ex:
            print("Failed to load", t0, "to", t1, "because", ex)
        else:
            created_file = average_data_2d(new_data, created_file)
